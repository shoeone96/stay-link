...
| F9 | `supplier-resilience` | 조회 4 | 완료(병합) | 2026-09-07 | 2026-09-07 |
| F10 | `search-cache` | 조회 5 | 완료(병합) | 2026-09-07 | 2026-09-07 |
| F11 | `unmapped-code-recovery` | D11 비동기 트랙 (선택) | 하지 않음 (2026-09-07) | - | - |
...
> **범위 확정 (2026-09-07).** 착수 전 고민과 조사(출처 51건 검증)는 `docs/ai-history.md` 91·92번.
...
- **닫힌 결정** (2026-09-07 착수 전 확정, 근거는 ai-history 91·92번)

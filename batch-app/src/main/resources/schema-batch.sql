-- Spring Batch 메타데이터 테이블 (MySQL).
-- 원본은 spring-batch-core 6.0.5 의 schema-mysql.sql 이며, 매 기동마다 실행해도 되도록 IF NOT EXISTS 만 더했다.
-- Spring Batch 를 올릴 때는 그 버전의 schema-mysql.sql 과 이 파일을 대조해야 한다 (D-F6-16 의 대가).
